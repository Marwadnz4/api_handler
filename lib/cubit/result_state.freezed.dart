...
class _$SuccessImpl<T> with DiagnosticableTreeMixin implements Success<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResultState<$T>.success'))
...
class _$FailureImpl<T> with DiagnosticableTreeMixin implements Failure<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ResultState<$T>.failure(networkExceptions: $networkExceptions)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ResultState<$T>.failure'))
